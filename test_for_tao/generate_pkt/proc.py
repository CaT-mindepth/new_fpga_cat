...
def main():
    if (args.direction == 'conf_to_ctrl_pkt'):
        ...
        # pkts.append(pkt)
        pkt = func.gen_data_pkt("0000000500000000300000000000"+4*"00", 1)
        pkts.append(pkt)
        pkt = func.gen_data_pkt("00000003000000003000"+8*"00", 1)
        pkts.append(pkt)
        pkt = func.gen_data_pkt("00000003000000006000"+8*"00", 1)
        pkts.append(pkt)
